function sky_reset(rng)
    ...
    out[2] = {
        unit_type="small_tower",
        faction=0,
        pos={x=33.794095033131, y=33.254140643484},
    }

    out[3] = {
        unit_type="big_tower",
        faction=1,
        pos={x=33.059110564359, y=14.390460944012},
    }

    out[4] = {
        unit_type="big_tower",
        faction=0,
        pos={x=14.098966935466, y=33.988222724488},
    }

    out[5] = {
        unit_type="small_tower",
        faction=1,
        pos={x=13.118326699738, y=12.586588909103},
    }
